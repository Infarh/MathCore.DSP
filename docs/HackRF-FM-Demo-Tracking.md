...
- [x] Этап 3. Гетеродин +0.8 МГц
- [x] Этап 4. ФНЧ + децимация x25
- [x] Этап 5. Ресемплинг x12/x5
- [x] Этап 6. FM-демодуляция + децимация до 48 кГц
- [x] Этап 7. Вывод в NAudio
- [x] Этап 8. Документация примера
