...
[TestClass]
public class ChebyshevLowPass : ChebyshevFiltersTests
{
    [TestMethod]
    public void TypeI_Creation()
    {
        ...
        var filter = new DSP.Filters.ChebyshevLowPass(dt, fp, fs, Gp, Gs, ChebyshevType.I);
    ...
    public void TypeII_Creation()
    {
        ...
        var (B, b_im) = GetCoefficientsInverted(z_zeros);
        var (A, a_im) = GetCoefficientsInverted(z_poles);
        ...
        var filter = new DSP.Filters.ChebyshevLowPass(dt, fp, fs, Gp, Gs, ChebyshevType.II);
    ...
    public void TypeIICorrected_Creation()
    {
        ...
        var filter = new DSP.Filters.ChebyshevLowPass(dt, fp, fs, Gp, Gs, ChebyshevType.IICorrected);
