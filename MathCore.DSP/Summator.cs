...
/// <summary>Предоставляет функциональность для создания делегатов суммирования элементов массива</summary>
/// <remarks>
/// Используется динамическая генерация методов для создания эффективных реализаций суммирования,
/// что позволяет избежать накладных расходов, связанных с использованием стандартных методов суммирования.
/// </remarks>
public class Summator
{
    /// <summary>Создание делегата суммирования элементов массива целых чисел</summary>
    /// <returns>Делегат суммирования элементов массива целых чисел</returns>
