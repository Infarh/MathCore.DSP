...
/// <summary>Окно Наталла (Nuttall)</summary>
/// <remarks>
/// Многочленное окно с очень низкими боковыми лепестками и высокой гладкостью, обеспечивает отличное подавление утечки спектра
/// Выбирается при необходимости минимизировать боковые лепестки при допустимом расширении главного лепестка, полезно для измерительных задач
/// См.: A. H. Nuttall, Some Windows with Very Good Sidelobe Behavior, IEEE Trans. Acoust., Speech, Signal Processing, 1981, https://ieeexplore.ieee.org/document/1163506
/// </remarks>
public static class NuttallWindow
{
    private const double a0 = 0.355768;
    private const double a1 = 0.487396;
    private const double a2 = 0.144232;
    private const double a3 = 0.012604;
    ...
    /// <summary>Значение параметризованного окна Nuttall в дискретной точке</summary>
    /// <param name="n">Номер отсчёта (0 ≤ n &lt; N)</param>
    /// <param name="N">Размер окна</param>
    ...
    /// <summary>Значение параметризованного окна Nuttall в нормированной точке</summary>
    /// <param name="x">Нормированная позиция в интервале [0;1]</param>
    /// <param name="a0">Коэффициент a0</param>
    /// <param name="a1">Коэффициент a1</param>
    /// <param name="a2">Коэффициент a2</param>
