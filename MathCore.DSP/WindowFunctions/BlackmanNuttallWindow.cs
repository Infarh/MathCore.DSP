...
/// <summary>Окно Блэкмана–Наталла (Blackman–Nuttall)</summary>
/// <remarks>
/// Вариант многочленного окна с очень низкими боковыми лепестками и плавным спадом, обеспечивающий хорошее подавление утечки спектра
/// Выбирается при анализе сигналов с широким динамическим диапазоном амплитуд, где критично минимизировать уровень боковых лепестков
/// См.: R. Nuttall, Some Windows with Very Good Sidelobe Behavior, IEEE Trans. Acoust., Speech, Signal Processing, 1981; а также F. J. Harris, 1978, https://ieeexplore.ieee.org/document/1455100
/// </remarks>
public static class BlackmanNuttallWindow
{
    ...
    /// <summary>Значение параметризованного окна Blackman–Nuttall в дискретной точке</summary>
    /// <param name="n">Номер отсчёта (0 ≤ n &lt; N)</param>
    /// <param name="N">Размер окна</param>
    ...
    /// <summary>Значение параметризованного окна Blackman–Nuttall в нормированной точке</summary>
    /// <param name="x">Нормированная позиция в интервале [0;1]</param>
    /// <param name="a0">Коэффициент a0</param>
    /// <param name="a1">Коэффициент a1</param>
    /// <param name="a2">Коэффициент a2</param>
